...
func (r *EventSettingsRepository) Update(ctx context.Context, settings *models.EventSettings) error {
	query := `
		...
		SET enable_twitch_subs = $1,
		    ...
		    enable_youtube_super_chat = $7,
		    enable_youtube_super_sticker = $8,
		    enable_youtube_members = $9,
		    enable_youtube_member_milestones = $10,
		    enable_youtube_member_gifts = $11,
		    enable_kick_subs = $12,
		    enable_kick_gifts = $13,
		    enable_tiktok_likes = $14,
