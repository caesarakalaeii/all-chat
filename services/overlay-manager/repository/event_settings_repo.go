...
func (r *EventSettingsRepository) GetByOverlayID(ctx context.Context, overlayID string) (*models.EventSettings, error) {
	query := `
		SELECT id, overlay_id,
		       ...
		       enable_twitch_follows, enable_twitch_watch_streaks,
...
func (r *EventSettingsRepository) Update(ctx context.Context, settings *models.EventSettings) error {
	query := `
		...
		SET enable_twitch_subs = $1,
		    ...
		    enable_twitch_watch_streaks = $8,
		    enable_youtube_super_chat = $9,
		    enable_youtube_super_sticker = $10,
		    enable_youtube_members = $11,
		    enable_youtube_member_milestones = $12,
		    enable_youtube_member_gifts = $13,
		    enable_kick_subs = $14,
		    enable_kick_gifts = $15,
		    enable_tiktok_likes = $16,
	...
	row := r.pool.QueryRow(ctx, query,
		...
		settings.EnableTwitchWatchStreaks,
