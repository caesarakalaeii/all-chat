...
- [ ] OAuth tokens encrypted at rest (currently basic, TODO: AES-GCM)
...
1. Token encryption is basic (XOR, TODO: migrate to AES-GCM)
2. No service-to-service auth (only NetworkPolicies)
...
2. **Cryptographic Failures**: Check token encryption (currently weak)
