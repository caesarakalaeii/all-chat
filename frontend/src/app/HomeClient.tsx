...
const FEATURE_CARDS = [
  { icon: Palette, messageStem: 'themes' },
  { icon: Zap, messageStem: 'emotes' },
  { icon: LayoutGrid, messageStem: 'resources' },
        ...
        {isLoggedIn ? (
          <>
            ...
            >
              ...
              {user.is_admin
                ? t('marketing.hero.adminDashboard')
                : t('marketing.hero.goToDashboard')}
            </Link>
          </>
        ) : (
          <>
        ...
        <>
          ...
          <section className="mx-auto max-w-5xl border-t border-border px-4 py-16">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              {FEATURE_CARDS.map(({ icon: Icon, messageStem }) => (
                <SpotlightCard
                  key={messageStem}
                ...
                >
                  ...
                  <h3 className="mb-2 text-lg font-semibold text-text">
                    {t(`marketing.why.${messageStem}Title`)}
                  </h3>
                  <p className="text-sm text-text-sub">{t(`marketing.why.${messageStem}Body`)}</p>
                </SpotlightCard>
              ))}
            </div>
            ...
            <div className="mt-12 flex flex-wrap items-center justify-center gap-x-3 gap-y-3 text-sm">
              <span className="font-semibold text-text">{t('marketing.steps.heading')}</span>
              {STEP_MESSAGE_STEMS.map((stem, i) => (
                <span key={stem} className="flex items-center gap-3">
                  <span className="flex items-center gap-2 text-text-sub">
                    ...
                    {t(`marketing.steps.${stem}`)}
                  </span>
                  {i < STEP_MESSAGE_STEMS.length - 1 && (
          ...
          <section className="mx-auto max-w-5xl border-t border-border px-4 py-16">
            <p className="mb-3 text-center text-xs font-bold tracking-widest text-text-sub uppercase">
              {t('marketing.beyond.eyebrow')}
            </p>
            <h2 className="mb-10 text-center text-2xl font-bold text-text">
              {t('marketing.beyond.title')}
            </h2>
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="rounded-xl border border-border bg-surface p-6">
                <h3 className="mb-1.5 flex items-center gap-2 text-lg font-bold text-text">
                  ...
                  {t('marketing.beyond.extensionTitle')}
                </h3>
                <p className="mb-4 text-sm text-text-sub">{t('marketing.beyond.extensionBody')}</p>
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  >
                    ...
                    {t('marketing.beyond.githubReleases')}
                  </a>
                </div>
              </div>
              ...
              <div className="rounded-xl border border-border bg-surface p-6">
                <h3 className="mb-1.5 flex items-center gap-2 text-lg font-bold text-text">
                  ...
                  {t('marketing.beyond.apiTitle')}
                </h3>
                <p className="mb-4 text-sm text-text-sub">{t('marketing.beyond.apiBody')}</p>
                <Link
                  href="/docs/api"
