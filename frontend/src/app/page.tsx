      ...
      <div className="container mx-auto px-4 py-20">
        <div className="text-center">
          ...
          <div className="max-w-md mx-auto space-y-4">
            ...
            >
              {/* Twitch Logo - Using white on purple background per branding */}
              <svg
                className="w-6 h-6"
                viewBox="0 0 24 24"
            ...
            <button
              ...
              className="w-full bg-[#00E701] hover:bg-[#00C001] text-black font-semibold py-4 px-6 rounded-lg text-lg transition-colors flex items-center justify-center gap-2"
            >
              {/* Kick Logo - Using black on brand green background */}
              <svg
                className="w-6 h-6"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path fill="#000000" d="M21 0H3C1.343 0 0 1.343 0 3v18c0 1.657 1.343 3 3 3h18c1.657 0 3-1.343 3-3V3c0-1.657-1.343-3-3-3zm-9.5 17.5l-4-4 4-4v3h6v2h-6v3z" />
              </svg>
              Login with Kick
            </button>
            ...
            <div className="flex items-center justify-center gap-4 text-gray-400 text-sm flex-wrap">
              <div className="flex items-center gap-2">
                {/* Twitch icon - Official purple #9146FF per branding guidelines */}
              ...
              <div className="flex items-center gap-2">
                {/* YouTube icon - Using official red #FF0000 per branding guidelines, min size 20dp/3.1mm */}
                <svg className="w-5 h-5" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-2">
                {/* TikTok icon - Official black #000000 per branding guidelines */}
                <svg className="w-5 h-5" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-2">
                {/* Kick icon - Official green #00E701 per branding guidelines */}
                <svg className="w-5 h-5" viewBox="0 0 24 24">
                  <path fill="#00E701" d="M21 0H3C1.343 0 0 1.343 0 3v18c0 1.657 1.343 3 3 3h18c1.657 0 3-1.343 3-3V3c0-1.657-1.343-3-3-3zm-9.5 17.5l-4-4 4-4v3h6v2h-6v3z" />
                </svg>
                Kick
              </div>
            </div>
