 ...
 *
 * Displays a warning banner for platforms in closed beta.
 * Non-blocking - informs users but allows them to proceed if they're already in the beta.
 */
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-300 mb-4">
              {platformName} integration is currently in <strong>closed beta</strong>. If you haven&apos;t been added to the beta program yet, authentication will fail.
            </p>
            <p className="text-gray-300 mb-4">
