...
export const viewerOverlay = {
  ...
  // browser dock, roughly 300-450px wide with no browser chrome. A sibling of
  // `monitor` rather than a group inside it because the catalog nests three
  // levels deep at most (docs/frontend/I18N.md).
  dock: {
